...
## Dashboard
For showing the prediction we use a static site generated by github action.  The site is generated using the `index.md` file and the images generated by the inference pipeline.
